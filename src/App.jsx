            ...
            {isTrueView ? (
                <div className="min-h-screen bg-pastel-green text-gray-800 flex flex-col justify-center items-center">
                    ...
                    <footer className="bg-white shadow-md p-4 mt-8 rounded-lg">
                        ...
                        <ul className="flex space-x-4 mt-2 underline">
                            <li>
                              <button className="underline hover:shadow-outline-blue focus:shadow-outline-blue" onClick={toggleView}>Email</button>
                            </li>
                            <li>
